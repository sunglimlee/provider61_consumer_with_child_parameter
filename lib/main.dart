  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
          ...
          children: <Widget>[
            ...
            Consumer<ColourNotifier>(
              builder: (context, value, child) {
                return RedBox(isRed: value.isRed, child: child,); // 여기서 child 를 빼니깐 아예 child 를 패스해버리고 안찍어버리네..
              },
              child:  const CounterNumber(number : 0),
              /*
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () => Provider.of<ColourNotifier>(context, listen: false).switchColour(),
